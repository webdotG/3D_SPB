...
const projects = [
  ...
  },
  {
    ...
    description: 'Позволяет виртуально исследовать внутреннее пространство помещения.',
  ...
  },
  {
    ...
    description: 'Помогает вам соориентироваться в доступных вариантах и принять информированное решение.',
